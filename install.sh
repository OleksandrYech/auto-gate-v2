...
# Завантаження моделі MobileNet SSD
echo "Завантаження моделі детекції автомобілів..."
wget -O models/mobilenet_ssdv1.onnx https://github.com/onnx/models/raw/main/validated/vision/object_detection_segmentation/ssd-mobilenetv1/model/ssd_mobilenet_v1_12.onnx
...
Environment="PATH=$(pwd)/gate/bin"
ExecStart=$(pwd)/gate/bin/python main.py
Restart=always
RestartSec=10
...
sudo cp gate_automation.service /etc/systemd/system/
